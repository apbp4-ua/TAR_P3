...
static const _Conversion_Request_type_support_symbol_names_t _Conversion_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, srv_service_temp, srv, Conversion_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, srv_service_temp, srv, Conversion_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, srv_service_temp, srv, Conversion_Request)() {
  return &::srv_service_temp::srv::rosidl_typesupport_c::Conversion_Request_message_type_support_handle;
}
...
static const _Conversion_Response_type_support_symbol_names_t _Conversion_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, srv_service_temp, srv, Conversion_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, srv_service_temp, srv, Conversion_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, srv_service_temp, srv, Conversion_Response)() {
  return &::srv_service_temp::srv::rosidl_typesupport_c::Conversion_Response_message_type_support_handle;
}
...
static const _Conversion_type_support_symbol_names_t _Conversion_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, srv_service_temp, srv, Conversion)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, srv_service_temp, srv, Conversion)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, srv_service_temp, srv, Conversion)() {
  return &::srv_service_temp::srv::rosidl_typesupport_c::Conversion_service_type_support_handle;
}
