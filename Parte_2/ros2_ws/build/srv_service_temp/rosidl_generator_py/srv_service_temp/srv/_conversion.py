...
class Metaclass_Conversion_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('srv_service_temp')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_Conversion(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'srv_service_temp.srv.Conversion')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from srv_service_temp.srv import _conversion
...
class Conversion(metaclass=Metaclass_Conversion):
    from srv_service_temp.srv._conversion import Conversion_Request as Request
    from srv_service_temp.srv._conversion import Conversion_Response as Response
