...
bool srv_service_temp__srv__conversion__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("srv_service_temp.srv._conversion.Conversion_Request", full_classname_dest, 51) == 0);
  }
  srv_service_temp__srv__Conversion_Request * ros_message = _ros_message;
  {  // input_temp
...
PyObject * srv_service_temp__srv__conversion__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("srv_service_temp.srv._conversion");
...
ROSIDL_GENERATOR_C_EXPORT
bool srv_service_temp__srv__conversion__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("srv_service_temp.srv._conversion.Conversion_Response", full_classname_dest, 52) == 0);
  }
  srv_service_temp__srv__Conversion_Response * ros_message = _ros_message;
  {  // converted_temp
